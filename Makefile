...
PYETS_DEP:=src/astronomy.cc src/pyETS.cc src/ets_assigners.cc src/*.h src/external/*
PYETS_SRC:=src/astronomy.cc src/pyETS.cc src/ets_assigners.cc src/external/*.cc
